...
# FIX: New Telegram supergroup/channel IDs can be larger than the old
# Pyrogram range. Pyrogram's default get_peer_type() may reject valid
# -100xxxxxxxxxx IDs. Treat every -100... ID as a channel/supergroup peer.
